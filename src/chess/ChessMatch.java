...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		promoted = null;
		if (movedPiece instanceof Pawn) {  // Testar se a peça (peão) chegou ao final do tabuleiro
		...
		if (movedPiece instanceof Pawn // Testar se é um peão e se andou 2 casas
				&& (target.getRow() == source.getRow() - 2 || target.getRow() == source.getRow() + 2)) {
			enPassantVulnerable = movedPiece; // Se atendeu aos critérios, a peça está vunerável ao movimento especial
		} else {
	...
	// Método auxiliar para instanciar peças
	...
	private Piece makeMove(Position source, Position target) {
		...
		// Movimento En Passant
		if (p instanceof Pawn) { // Peão andou na diagonal e não capturou peça, significa que ocorreu en passant
	...
	private void undoMove(Position source, Position target, Piece capturedPiece) { // Desfazer movimento
		...
		if (p instanceof King && target.getColumn() == source.getColumn() + 2) {
			...
			board.placePiece(rook, sourceT); // Torre para a posiçãod e origem
	...
	// Varrer todas as peças adversárias para testar se algum movimento cai na casa
	// do Rei, com isso ocasionar o check
